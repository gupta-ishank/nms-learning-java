...
public class Transaction {
	...
	public static void main(String[] args) {
		...
		Transaction a = new Transaction(10000L, Type.CREDIT, 2);
		Transaction a = new Transaction(50000L, Type.DEBIT, 3);
		Transaction a = new Transaction(70000L, Type.DEBIT, 4);
		...
		// using streams, above code is converted into shorter form, SQL like syntax, no need of for loops and checks for every element in list
		...
		List<Integer> streamedtransactionsIds = 
				transactionList.stream()
						...
						.sorted(Comparator.comaparing(Transaction::getAmount).reversed())
